...
*This buildpack is a fork of original Ruby buildpack that will automatically execute rake db:migrate task if it exists in the Rakefile. The original work has been done by [Dan Tao](https://github.com/dtao) here: https://github.com/dtao/rake-db-migrate-buildpack*
